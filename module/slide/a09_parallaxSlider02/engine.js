bd.slide.A09_parallaxSlider02 = function() {
	this.init.apply(this, arguments);
};

bd.slide.A09_parallaxSlider02.prototype = {
	isReady: false,
	
	init: function() {
		bd.util.addCss(bindobj.moduleroot + '/slide/_common/ParallaxSlider/style.css');
		bd.util.addCss(bindobj.moduleroot + '/slide/a09_parallaxSlider02/style.css');
	...
	render: function( elem, autost, loop ) {
		...
		var slide = jQuery('<div class="pxs_container a09_parallaxSlider02">').css({
			width: w,
			height: h,
