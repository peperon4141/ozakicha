bd.slide.A59_rotatingImage07 = function() {
	this.init.apply(this, arguments);
};

bd.slide.A59_rotatingImage07.prototype = {
	isReady: false,
	
	init: function() {
		head.load([
			bindobj.moduleroot + '/slide/_common/RotatingImageSlider/RotatingImageSlider.css',
			bindobj.moduleroot + '/slide/a59_rotatingImage07/style.css',
	...
	render: function( elem, autost, loop ) {
		...
		var container = jQuery('<div class="sp box_rotatingImage a59_rotatingImage07">').css({
			visibility: 'hidden',
