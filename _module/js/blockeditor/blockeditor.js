...
if(!bindobj.isCloud) Value.outOpacity = new Array('0.2','alpha(opacity=20)');
...
var BlockEdit = {
	...
	toolbar: function() {
		...
		var setstyle = function(id) {
			...
			id.style.background = 'url(' + Value.rootDir + '/js/blockeditor/BlockToolbar.png) no-repeat';
		...
		setstyle(btnCopy);
		btnCopy.style.backgroundPosition = '-178px top';
	...
	moveSize: function(e) {
		if (BlockEdit.sizeArea) {
			if (bindobj.ie) {
				...
				if (bindobj.ie110 || bindobj.ie100 || bindobj.ie90) {
