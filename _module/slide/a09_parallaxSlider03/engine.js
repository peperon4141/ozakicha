bd.slide.A09_parallaxSlider03 = function() {
	this.init.apply(this, arguments);
};

bd.slide.A09_parallaxSlider03.prototype = {
	isReady: false,
	
	init: function() {
		bd.util.addCss(bindobj.moduleroot + '/slide/_common/ParallaxSlider/style.css');
		bd.util.addCss(bindobj.moduleroot + '/slide/a09_parallaxSlider03/style.css');
	...
	render: function( elem, autost, loop ) {
		...
		var slide = jQuery('<div class="pxs_container a09_parallaxSlider03">').css({
			width: w,
			height: h,
