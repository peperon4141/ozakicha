bd.slide.A09_parallaxSlider08 = function() {
	this.init.apply(this, arguments);
};

bd.slide.A09_parallaxSlider08.prototype = {
	isReady: false,
	
	init: function() {
		bd.util.addCss(bindobj.moduleroot + '/slide/_common/ParallaxSlider/style.css');
		bd.util.addCss(bindobj.moduleroot + '/slide/a09_parallaxSlider08/style.css');
	...
	render: function( elem, autost, loop ) {
		...
		var slide = jQuery('<div class="pxs_container a09_parallaxSlider08">').css({
			width: w,
			height: h,
