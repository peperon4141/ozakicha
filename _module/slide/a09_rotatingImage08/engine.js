bd.slide.A09_rotatingImage08 = function() {
	this.init.apply(this, arguments);
};

bd.slide.A09_rotatingImage08.prototype = {
	isReady: false,
	
	init: function() {
		head.load([
			bindobj.moduleroot + '/slide/_common/RotatingImageSlider/RotatingImageSlider.css',
			bindobj.moduleroot + '/slide/a09_rotatingImage08/style.css',
	...
	render: function( elem, autost, loop ) {
		...
		var container = jQuery('<div class="box_rotatingImage a09_rotatingImage08">').css({
			visibility: 'hidden',
